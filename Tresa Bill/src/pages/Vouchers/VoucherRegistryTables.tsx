...
interface VoucherRegistryTablesProps {
...
export default function VoucherRegistryTables({
  singles,
  batches,
  selected,
  deletingVoucher,
      ...
      <section className="space-y-2">
        <div className="flex items-end justify-between">
          <div>
            ...
            <p className="text-[11px] text-muted-foreground">Each generated batch is kept as one bundle.</p>
          </div>
            ...
            <Table>
              <TableHeader className="bg-muted/30">
                <TableRow>
                  ...
                  <TableHead className="text-xs font-bold">Batch Value</TableHead>
                  <TableHead className="text-xs font-bold">Router Status</TableHead>
